...
const slides = [
  ...
  },
  {
    ...
    subTitle: "Ngo Hoang Home – Uy tín tạo niềm tin",
    ...
    <div className="min-h-screen bg-background text-foreground scroll-smoothSelection">
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Ngo Hoang Home là đơn vị hàng đầu trong lĩnh vực thi công trần thạch cao, sơn bả và sơn tường tại Hà Nội. Với đội ngũ thợ lành nghề, chúng tôi cam kết mang đến những không gian sống hiện đại, bền đẹp và sang trọng bậc nhất.
                  </p>
                </div>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                Mỗi dịch vụ tại Ngo Hoang Home đều được kiểm soát chất lượng nghiêm ngặt, từ khâu chọn vật liệu đến kỹ thuật thi công.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <Button variant="ghost" className="p-0 text-primary hover:text-primary-hover group/link hover:bg-transparent">
                  Xem thêm <span className="ml-2 group-hover/link:translate-x-1 transition-transform">→</span>
                </Button>
              </motion.div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-6 group">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold tracking-tight">nhatnhi3344@gmail.com</p>
                    </div>
                  </div>
                ...
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input type="text" className="w-full bg-secondary border-none rounded-lg p-4 focus:ring-2 focus:ring-primary outline-none transition-all" placeholder="Nguyễn Văn A" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-bold uppercase tracking-widest">Số điện thoại</label>
                      <input type="tel" className="w-full bg-secondary border-none rounded-lg p-4 focus:ring-2 focus:ring-primary outline-none transition-all" placeholder="0xxx.xxx.xxx" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold uppercase tracking-widest">Địa chỉ công trình</label>
                    <input type="text" className="w-full bg-secondary border-none rounded-lg p-4 focus:ring-2 focus:ring-primary outline-none transition-all" placeholder="Vinhomes Smart City, Cầu Giấy..." />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold uppercase tracking-widest">Nội dung yêu cầu</label>
                    <textarea rows={4} className="w-full bg-secondary border-none rounded-lg p-4 focus:ring-2 focus:ring-primary outline-none transition-all resize-none" placeholder="Ví dụ: Thi công trần thạch cao 50m2 phòng khách..." defaultValue={""} />
                  </div>
                  <Button className="w-full h-14 text-white text-base font-bold bg-primary hover:bg-primary-hover rounded-xl shadow-lg transition-all">
                    Gửi yêu cầu hỗ trợ <Zap className="ml-2 w-5 h-5" />
                  </Button>
                  <p className="text-center text-sm text-muted-foreground pt-4 flex items-center justify-center gap-2">
                    <ShieldCheck className="w-4 h-4 text-primary" /> Bảo mật thông tin khách hàng tuyệt đối.
                  </p>
                </form>
              </Card>
            </div>
      ...
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-4">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.9 }}
          href="#"
          className="w-14 h-14 bg-charcoal text-white flex items-center justify-center rounded-full shadow-lg"
        >
